    ...
    private void loadUserDetail(ModelReview modelReview, final HolderReview holder) {
        ...
        ref.child(uid).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                try{
                    Picasso.get().load(profileImage).placeholder(R.drawable.admin_person_bg).into(holder.profileIv);
                }catch (Exception e){
                    holder.profileIv.setImageResource(R.drawable.admin_person_bg);
                }
